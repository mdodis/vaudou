...
static inline const char* vkpresentmodekhr_to_string(VkPresentModeKHR input_value) {
    switch (input_value) {
...
static inline const char* vkcolorspacekhr_to_string(VkColorSpaceKHR input_value) {
    switch (input_value) {
...
static inline const char* vkformat_to_string(VkFormat input_value) {
    switch (input_value) {
